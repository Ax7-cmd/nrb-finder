                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                Rma List
                                <br>
                                <small class="text-info align-left">Data RMA yang di upload harus sudah sesuai dengan
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Import RMA</h5>
        ...
        methods: {
            ...
            exportData() {
                let routeData = this.$router.resolve({
                    path: '/export-rma?search=' + this.query.search
                });
