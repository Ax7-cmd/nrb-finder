                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                CN List
                                <br>
                                <small class="text-info align-left">Data CN yang di upload harus sudah sesuai dengan
                        ...
                        <div class="card-body table-responsive p-0" style="height: 440px;" @scroll="handleScroll">
                            <table class="table table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    <tr v-for="cnData in data" :key="cnData.no_faktur">
                                        <td>{{cnData.no_rma_oracle}}</td>
                                        <td>{{cnData.no_cn}}</td>   
                                        <td>{{cnData.tgl_cn}}</td>
                                        <td>{{cnData.no_rr}}</td>
                                        <td>{{ cnData.amount | numberFormat }}</td>
                                    </tr>
                                </tbody>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Import CN</h5>
        ...
        methods: {
            ...
            exportData() {
                let routeData = this.$router.resolve({
                    path: '/export-acc?search=' + this.query.search
                });
