                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                TTRS List
                                <br>
                                <small class="text-info align-left">Data Penarikan whs yang di upload harus sudah sesuai dengan
                        ...
                        <div class="card-body table-responsive p-0" style="height: 440px;" @scroll="handleScroll">
                            <table class="table table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    <tr v-for="whsData in data" :key="whsData.no_ttrs">
                                        <td>{{whsData.no_ttrs}}</td>
                                        <td>{{whsData.no_faktur}}</td>
                                        <td>{{whsData.tgl_ttrs}}</td>
                                    </tr>
                                </tbody>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Import TTRS</h5>
        ...
        methods: {
            ...
            exportData() {
                let routeData = this.$router.resolve({
                    path: '/export-whs?search=' + this.query.search
                });
